 ...
 <div className="relative mx-auto flex flex-col px-4 sm:max-w-xl md:max-w-screen-xl md:flex-row">
   <div className="my-auto mx-auto mt-8 w-full max-w-xl md:mt-56 lg:max-w-screen-xl ">
     <div className="mb-16 lg:mb-0 lg:max-w-lg">
       ...
       <a href="/" class="mr-6 inline-flex h-12 items-center justify-center rounded bg-green-600 px-6 font-bold tracking-wide text-black shadow-md outline-none transition duration-200 hover:bg-indigo-400 focus:ring"> SHOP NOW </a>
       </div>
     </div>
   </div>
