...
return (
	...
	<br></br><br></br><br></br>
		...
		<button onClick={tambah} class="inline-block rounded-full bg-green-500 px-6 pb-2 pt-2.5 text-xs font-bold  leading-center text-black-900 transition duration-150 ease-in-out hover:bg-primary-accent-100 focus:bg-primary-accent-100 focus:outline-none focus:ring-0 active:bg-primary-accent-200">
			...
			<div className="mb-3 pt-0 text-center">
			<button onClick={reset} class="inline-block rounded-full bg-blue-400 px-6 pb-2 pt-2.5 text-xs font-bold  leading-center text-black-900 transition duration-150 ease-in-out hover:bg-primary-accent-100 focus:bg-primary-accent-100 focus:outline-none focus:ring-0 active:bg-primary-accent-200">
			Reset</button>
			</div>
		</div>
		<br></br>
